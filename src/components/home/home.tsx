        ...
        <div className={styles.container}>
            <div className={styles.body}>
                <div className={styles.anim}>
                    <h2 className={styles.h2}><span>Hello! My name is Ekaterina Kovrizhina and welcome to my portfolio website!</span></h2>
                </div>
                <h3>Click on 'projects' section to see my code.</h3>
