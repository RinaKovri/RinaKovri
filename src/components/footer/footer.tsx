...
const Footer: React.FC<FooterProps> = ({ onClick }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <li className={styles.git}><Link to='https://github.com/RinaKovri'>
      ...
      <li className={styles.linkedin}><Link to='https://www.linkedin.com/in/ekaterina-kovrizhina/'>
        <a target="_blank" rel="noreferrer">
        ...
        <li className={styles.btn}><div onClick={display}>
        </div></li>
        </ul>
    </div>
  )
