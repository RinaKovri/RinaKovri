...
const Cv: React.FC<CvProps> = () => {
  return (
    <div className={styles.container}>
      ...
      <li><h2 className={styles.h2left}>Skills</h2></li>
          ...
          <li><h2 className={styles.h2left}>Languages</h2></li>
          <ul className={styles.leftList}>
            <li className={styles.langItems}>Russian - native</li>
            <li className={styles.langItems}>English - upper-intermediate</li>
            <li className={styles.langItems}>Finnish - intermediate</li>
          </ul>
          <li><h2 className={styles.h2left}>Education</h2></li>
          <ul className={styles.leftList}>
      ...
      <ul className={styles.rightSide}>
        <li><h2 className={styles.h2right}>Experience</h2></li>
