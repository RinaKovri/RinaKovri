...
const Footer: React.FC<FooterProps> = () => {
  return (
    <div className={styles.container}>
      <ul>
        <li><a target="_blank" rel="noreferrer" href='https://github.com/RinaKovri'>
        ...
        <li><a target="_blank" rel="noreferrer" href='https://www.linkedin.com/in/ekaterina-kovrizhina/'>
